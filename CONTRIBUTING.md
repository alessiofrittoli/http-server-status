# Contributing to HTTP Server Status 📣

We’re excited that you’re interested in contributing to HTTP Server Status! This guide will help you get started.
...
- Search Existing Issues: Check the [Issues](https://github.com/alessiofrittoli/http-server-status/issues) tab to see if your concern has already been addressed.
...
- Go to the [repository page](https://github.com/alessiofrittoli/http-server-status).
- Click the Fork button.
- Clone your fork to your local machine:

```bash
git clone https://github.com/your-username/http-server-status.git
```
...
Thank you for helping improve HTTP Server Status! 🎉